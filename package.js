var page = 0;
      ...
      function nextPage() {
        ...
        if (page == 1) {
          ...
          document.getElementById('contents').innerHTML = '<br><br><br><br><br><br>You also understand that the Green OS team reserves the right to modify your submission to make it compatible with Green OS.  If you would like to preview your project, you can do so on the next page.<br><br><a href = "javascript:nextPage();"><img width = "50px" src = "nextBtn.png">';
        } else if (page == 3) {
